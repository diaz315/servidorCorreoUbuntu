...
MAIL_SUBDOMAIN="mail.$DOMAIN" #rouncCube
ADMIN_SUBDOMAIN="admin.$DOMAIN" # PostFixAdmin
...
debconf-set-selections <<< "postfix postfix/mailname string $MAIL_SUBDOMAIN"
debconf-set-selections <<< "postfix postfix/main_mailer_type string 'Internet Site'"
debconf-set-selections <<< "postfix postfix/destinations string $MAIL_SUBDOMAIN, $DOMAIN, localhost.localdomain, localhost"
...
hostnamectl set-hostname $MAIL_SUBDOMAIN

# Actualizar /etc/hosts
print_message "Actualizando /etc/hosts..."
echo "$SERVER_IP $MAIL_SUBDOMAIN mail" >> /etc/hosts
...
cat > /etc/apache2/sites-available/mail-admin << EOF
<VirtualHost *:80>
...
# Crear y habilitar el nuevo sitio
print_message "Configurando sitios de correo en Apache..."
a2ensite mail-admin.conf
...
print_message "- Webmail: http://mail.jdtech.com.co" #/webmail
print_message "- PostfixAdmin: http://admin.jdtech.com.co" #/postfixadmin/
print_message "- Contraseña de configuración inicial de PostfixAdmin: $SETUP_PASSWORD"
print_message ""
print_message "Para completar la configuración de PostfixAdmin:"
print_message "1. Accede a http://admin.jdtech.com.co/setup.php"
print_message "2. Usa la contraseña de configuración proporcionada"
...
print_message ""
print_message "IMPORTANTE: Asegúrate de tener configurados estos registros DNS:"
print_message "mail.jdtech.com.co.    IN A    $SERVER_IP"
print_message "admin.jdtech.com.co.   IN A    $SERVER_IP"
print_message "MX jdtech.com.co.      IN MX   10 mail.jdtech.com.co."
print_message ""
